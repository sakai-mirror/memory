 ...
 * @version $Id$
 */
public class RMISakaiCacheReplicatorFactory extends CacheEventListenerFactory {
    ...
    private static final Log LOG = LogFactory.getLog(RMISakaiCacheReplicatorFactory.class.getName());
    ...
    public final CacheEventListener createCacheEventListener(Properties properties) {
        ...
        if (replicateAsynchronously) {
            return new RMISakaiAsynchronousCacheReplicator(
                    replicatePuts,
                    replicateUpdates,
