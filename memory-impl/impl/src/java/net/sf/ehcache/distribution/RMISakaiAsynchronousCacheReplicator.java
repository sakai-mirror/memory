 ...
 * @version $Id$
 */
public class RMISakaiAsynchronousCacheReplicator extends RMISynchronousCacheReplicator {


    private static final Log LOG = LogFactory.getLog(RMISakaiAsynchronousCacheReplicator.class.getName());
     ...
     *
     */
    public RMISakaiAsynchronousCacheReplicator(
    ...
    public final void notifyElementPut(final Ehcache cache, final Element element) throws CacheException {
        ...
        if ( !ReplicationControl.clusterOnThisThread() ) {
        	return;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        //shutup checkstyle
        super.clone();
        return new RMISakaiAsynchronousCacheReplicator(replicatePuts, replicateUpdates,
